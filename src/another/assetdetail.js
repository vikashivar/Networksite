  ...
  useEffect(() => {
    async function api1() {
      const res = await fetch(
        `https://cms.verified.network/api/assets/${location}?populate=*`
      );
              ...
              <div className="d-flex justify-content-around flex-md-row flex-column text-center mx-5 mt-4 pt-2 ">
                ...
                >
                  ...
                  <span style={{ color: "#393939" }}>
                    {detail.data.attributes.asset_type.data.attributes.name}
                  </span>
                </div>
                <div
                  className="mb-2"
                ...
                >
                  Industry:{" "}
                  <span style={{ color: "#393939" }}>
                    {detail.data.attributes.industry}
                  </span>
                </div>
                <div
                  className="mb-2"
                ...
                >
                  Country:{" "}
                  <span style={{ color: "#393939" }}>
                    {detail.data.attributes.country.data.attributes.name}
                  </span>
                </div>
              </div>
            </div>
